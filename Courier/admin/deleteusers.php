...
<div class="admintitle">
    ...
    <h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b;">Users Registered Details</h1>
</div>
...
<table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-collapse: collapse;">
    <tr style="background-color: #5BC0F8;">
        <th>No.</th>
        <th>Users Name</th>
        <th>Email Id</th>
        <th>Action</th>
    ...
    <?php
        ...
        if(mysqli_num_rows($run)<1){
            ...
            <tr align="center">
                ...
                <td><a href="usersdeleted.php?emm=<?php echo $data['email']; ?>">deleteusers</a></td>
            </tr>
            <?php
            }
        }
