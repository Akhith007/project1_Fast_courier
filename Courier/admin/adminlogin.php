...
<body bgcolor="#3C79F5">
    <h4><a href="../index.php" style="float: right; margin-right:50px; color:#3C2A21">BackToHome</a></h4><br>
    <h1 align='center' style="color: #1A120B;font-size:60px">Admin Login</h1>
    <h5 align='center' style="color: #7B2869;font-weight: bold;font-size:15px">Work Hard to Grow More..</h5>
