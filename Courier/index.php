...
<body>
    <h1 align='center' style="margin: 15px; color:#fff;font-weight: bold;font-family:'Times New Roman', Times, serif">FAST COURIER SERVICE</h1>
    <hr />
    ...
    <div>
        <h5><a href="admin/adminlogin.php" style="float: right; margin-right:40px; color:#F2DEBA; margin-top:0px">Admin Login</a></h5>
    </div>
    <div class="container" style="margin-top: 60px; width:50%;">
        <div class="row">
            <div class="col-md-12">
                <h2  class="Login1" style="color: #86E5FF;">Login</h2>
                ...
                <form action="" method="post">
                    ...
                    <p style="color: #e84118;">Don't have an account?⮞➤ <a class="Sign" href="register.php">Sign Up</a>.</p>
